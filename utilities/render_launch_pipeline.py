...
CHECK_STATIC = [
    ...
    "embedding.yml",
    # trimming.yml omitted: juliac/trimming does not exist on release-1.11
...
def main():
    ...
    # NOTE (release-1.11): the JuliaSyntax and JuliaC launch groups that
    # `main` emits here are intentionally omitted on the release branch -- they
    # are not part of release-1.11's CI job set (the pre-#544 launch flow never
    ...
    # julia's in-repo .buildkite-external-version pointer. To opt release-1.11
