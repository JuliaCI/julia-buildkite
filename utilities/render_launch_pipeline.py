...
def main():
    ...
    # NOTE (release-1.12): the JuliaSyntax and JuliaC launch groups that
    # `main` emits here are intentionally omitted on the release branch -- they
    # are not part of release-1.12's CI job set (the pre-#544 launch flow never
    ...
    # julia's in-repo .buildkite-external-version pointer. To opt release-1.12
