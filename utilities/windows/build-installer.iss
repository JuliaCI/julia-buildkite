...
WizardImageFile={#RepoDir}\.buildkite\utilities\windows\julia-banner.bmp
WizardSmallImageFile={#RepoDir}\.buildkite\utilities\windows\julia-dots.bmp
SetupIconFile={#RepoDir}\.buildkite\utilities\windows\julia.ico
